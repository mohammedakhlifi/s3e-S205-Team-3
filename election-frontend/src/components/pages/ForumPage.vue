...
export default {
  ...
  methods: {
    ...
    async fetchTopics() {
      try {
        const response = await axios.get("https://election-backend-latest.onrender.com//api/forum/topics/latest")
    ...
    async postNewTopic() {
      try {
        ...
        await axios.post("https://election-backend-latest.onrender.com//api/forum/topics", this.newTopic);
        this.newTopic.title = "";
    ...
    async fetchUsername() {
      try {
        const response = await axios.get("https://election-backend-latest.onrender.com//api/user", {
